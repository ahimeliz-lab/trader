...
"[project]/lib/trading/equity.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function recordEquityPoint(accountId, priceTimeframe = "15m", note) {
    const sb = sbAdmin();
...
"[project]/app/api/execute/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/node_modules/@supabase/supabase-js/dist/index.mjs [app-route] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$trading$2f$equity$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/trading/equity.ts [app-route] (ecmascript)");
;
;
;
;
...
async function POST(req) {
    ...
    try {
        ...
        if (!body.clientOrderId) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: false,
        ...
        if (!body.plan) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ok: false,
            error: "plan required"
        }, {
            status: 400
        ...
        const feeUsd = Number.isFinite(body.feeUsd ?? NaN) ? body.feeUsd : 0;
        ...
        if (!Number.isFinite(fillPrice) || fillPrice <= 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: false,
                error: "No candle price available to fill."
            }, {
                status: 422
            });
        }
        // Account cash (for sizing baseline)
        const { data: acct, error: acctErr } = await sb.from("trade_accounts").select("id,cash_balance").eq("id", body.accountId).single();
        if (acctErr) throw new Error(`Account lookup failed: ${acctErr.message}`);
        const cash = Number(acct.cash_balance);
        if (!Number.isFinite(cash) || cash <= 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: false,
                error: "Account cash_balance invalid."
            }, {
                status: 422
            });
        }
        ...
        if (!Number.isFinite(stop) || stop <= 0) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                ok: false,
                error: "Invalid stop price in plan."
            }, {
                status: 422
            });
        }
        ...
        if (orderErr) {
            ...
            const { data: existing } = await sb.from("trade_orders").select("*").eq("account_id", body.accountId).eq("client_order_id", body.clientOrderId).maybeSingle();
            if (existing) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    ok: true,
                    idempotent: true,
        ...
        try {
            if (body.decisionId) {
                ...
                const { data: decision } = await sb.from("decision_logs").select("id").eq("symbol", symbol).order("created_at", {
                    ascending: false
                }).limit(1).maybeSingle();
                if (decision?.id) {
                    await sb.from("trade_orders").update({
        ...
        // Mark order filled
        const { error: updErr } = await sb.from("trade_orders").update({
            status: "filled"
        }).eq("id", order.id);
        if (updErr) throw new Error(`Order status update failed: ${updErr.message}`);
        // Record *true* equity point (cash + realized + unrealized)
        const eq = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$trading$2f$equity$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["recordEquityPoint"])(body.accountId, tf, `fill ${symbol} ${side} qty=${qty} price=${fillPrice}`);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__54198bff._.js.map
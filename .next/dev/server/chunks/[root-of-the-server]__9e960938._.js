...
"[project]/app/api/equity/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const sb = sbAdmin();
        const { data, error } = await sb.from("trade_equity_points").select("created_at,equity_usd,cash_usd,note").eq("account_id", accountId).order("created_at", {
            ascending: true
        }).limit(limit);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9e960938._.js.map